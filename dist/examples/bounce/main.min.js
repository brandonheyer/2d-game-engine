...
var BALL_RADIUS_MIN = 5;
var BALL_RADIUS_MAX = 75;
var GRAVITY = 9.8;
...
var BallEntity = function (_BaseEntity) {
  ...
  _createClass(BallEntity, [{
    ...
    value: function render(canvas) {
      this.element = canvas.makeCircle(this.xScale(this.pos.x), this.yScale(this.pos.y), this.xScale(this.radius));
...
var STARTING_COUNT = 250;

var entity;
var engine = new _dEngine.TwoEngine('.canvas', 800, 800, 10000, 10000, {
  trackFPS: true,
  displayFPS: (0, _jquery2.default)('.fps')
});
...
},{"./BallEntity":1,"2d-engine":"2d-engine","jquery":3}],3:[function(require,module,exports){
/*!
